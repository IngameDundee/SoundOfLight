...
namespace absurdjoy
{
    public class PlayerAvatar : MonoBehaviour
    {
        ...
        /// </summary>
        public void LinkWithLocal(Transform localRoot, Transform localHead, OVRCustomSkeleton localLeftSkeleton, OVRCustomSkeleton localRightSkeleton)
        {
            // RealtimeTransform requires explicit ownership to update the position.
            root.GetComponent<RealtimeTransform>().RequestOwnership();
